...
using NUnrar.Unpack.decode;
using NUnrar.Unpack.PPM;
using NUnrar.Unpack.VM;
...
namespace NUnrar.Unpack
{
    internal sealed class Unpack : Unpack20
    {
        ...
        */
        ...
        public void doUnpack(bool solid, CancellationToken cancellation)
        {
            if (solid)
            {
            ...
            {
                unstoreFile(cancellation);
            }
            switch (fileHeader.RarVersion)
            {
                case 15:  // rar 1.5 compression
                    unpack15(solid, cancellation);
                    break;

                case 20:
                // rar 2.x compression
                case 26:  // files larger than 2GB
                    unpack20(solid, cancellation);
                    break;

                case 29:
                // rar 3.x compression
                case 36:  // alternative hash
                    unpack29(solid, cancellation);
                    break;
            }
        }

        private void unstoreFile(CancellationToken cancellation)
        {
        ...
        private void unpack29(bool solid, CancellationToken cancellation)
        {
